...
model = YOLO(r"E:\5th sem project\runs\detect\train4\weights\best.pt")
...
db_config = {
    ...
    'user': 'sql12662020',  # Your MySQL username
    'password': 'E4KxhESkVD',  # Your MySQL password
    'database': 'sql12662020'  # The name of your database
}
...
while True:
    ...
    # Send the extracted text to the database
    if extracted_text:
        ladle_position = 'Furnace1'
        now = datetime.datetime.now()

        # Define the SQL query
        sql = "INSERT INTO data (LadleArriveTime, LadleNumber, LadlePosition) VALUES (%s, %s, %s)"

        # Define the values to be inserted
        values = (now.strftime("%Y-%m-%d %H:%M:%S"), extracted_text, ladle_position)
